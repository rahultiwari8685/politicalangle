        ...
        <div className={`article card-6 ${card.cardClass}`} key={idx}>
          ...
          <div className="card-body mt-md-0 mt-4">
            <Link href={card.linkPost}>
              <h6 className={`card-title cardTitle mb-2 ${card.cardTitle}`}>
                {card.title}
              </h6>
            </Link>
            <ul
              className={`d-flex align-items-center gap-4 text-600 m-0 ps-0 ${card.textColor}`}
            >
              <li className="list-unstyled">
                <p className={`fs-8 m-0 ${card.textColor}`}>{card.date}</p>
              </li>
              <li>
                <p className={`fs-8 m-0 pe-5 ${card.textColor}`}>
                  {card.readTime}
                </p>
              </li>
            </ul>
