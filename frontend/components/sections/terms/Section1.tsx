    ...
    <section className="sec-padding">
      <div className="container mx-auto max-w-5xl px-4">
        ...
        <div className="space-y-6 leading-relaxed text-gray-700">
          <div>
            <h2 className="mb-2 text-2xl font-semibold">1. सामग्री का उपयोग</h2>
          ...
          <div>
            <h2 className="mb-2 text-2xl font-semibold">2. समाचार की सटीकता</h2>

            <p>
              हम सही और विश्वसनीय जानकारी देने का प्रयास करते हैं, लेकिन सभी
              समाचारों की पूर्ण सटीकता की गारंटी नहीं देते।
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              उपयोगकर्ता वेबसाइट का गलत उपयोग, किसी प्रकार की हानिकारक गतिविधि
              या अवैध कार्य नहीं करेंगे।
            </p>
          </div>
